...
export default function DetailMotor({ motor, isOpen, onClose }) {
    ...
    const handleWhatsAppClick = () => {
        ...
        const waUrl = `https://wa.me/62881037678148?text=${encodeURIComponent(message)}`;
        window.open(waUrl, '_blank');
    };

    return (
        <div className="fixed inset-0 z-50 flex items-start md:items-center justify-center p-4 bg-black/85 backdrop-blur-sm overflow-y-auto">
            {/* Modal Box */}
                ...
                <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-between border-b md:border-b-0 md:border-r border-white/5">
                    ...
                    <div className="grid grid-cols-4 gap-4 mt-6">
                        ...
                        <div
                            ...
                            className={`aspect-[4/3] bg-black/40 rounded-sm overflow-hidden border transition duration-300 cursor-pointer ${activeImageIndex === 0 ? 'border-[#dc2626] scale-95' : 'border-transparent hover:border-white/25'
                                }`}
                        >
                        ...
                        {images.slice(1, 4).map((imgUrl, idx) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`aspect-[4/3] bg-black/40 rounded-sm overflow-hidden border transition duration-300 cursor-pointer ${activeImageIndex === actualIndex ? 'border-[#dc2626] scale-95' : 'border-transparent hover:border-white/25'
                                        }`}
                                >
                        ...
                        {images.length < 4 && [...Array(4 - images.length)].map((_, idx) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`aspect-[4/3] bg-black/40 rounded-sm overflow-hidden border transition duration-300 cursor-pointer ${activeImageIndex === duplicateIndex ? 'border-[#dc2626] scale-95' : 'border-transparent hover:border-white/10 opacity-60'
                                        }`}
                                >
